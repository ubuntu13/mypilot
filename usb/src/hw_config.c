...
void USART_Config_Default(void)
{
  ...
  */
  USART_InitStructure.USART_BaudRate = 915200;
...
void USB_Send_Data(u8* data_buffer, u8 num)
{
  count_in=num;
...
void USART_To_USB_Send_Data(void)
{
  ...
  {
    buffer_in[count_in] = USART_ReceiveData(USART2) & 0x7F;
  }
  else if (linecoding.datatype == 8)
  {
    buffer_in[count_in] = USART_ReceiveData(USART2);
  }
  count_in++;
